...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/ans.fhir.fr.test_ig_bpit|current/StructureDefinition/StructureDefinition-fr-patient.json)
...
```json
{
  ...
  "status" : "draft",
  "date" : "2026-07-23T06:55:30+00:00",

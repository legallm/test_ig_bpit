...
Vous pouvez également vérifier [les usages dans le FHIR IG Statistics](https://packages2.fhir.org/xig/ans.fhir.fr.test_ig_bpit|current/StructureDefinition/fr-patient)
...
* [https://interop.esante.gouv.fr/ig/test_ig_bpit/StructureDefinition/EyeColor](StructureDefinition-EyeColor.md)
...
```json
{
  ...
  "id" : "fr-patient",
  "url" : "https://interop.esante.gouv.fr/ig/test_ig_bpit/StructureDefinition/fr-patient",
  "version" : "0.1.0",
  "name" : "FrPatient",
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://interop.esante.gouv.fr/ig/test_ig_bpit/StructureDefinition/EyeColor"]
      }],
      "mustSupport" : true
    },
    {
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "required",
        "valueSet" : "https://interop.esante.gouv.fr/ig/test_ig_bpit/ValueSet/ModifiedAdministrativeGender"
      }
    }]
  }
}
